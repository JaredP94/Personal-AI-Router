...
// (discovery:nodes snapshots for the om service) into the subscribed overlay,
// merged with user-added manual nodes. The proxy is itself advertised — as an om
...
// thin re-export of the shared helper (it was triplicated across the proxies
...
type Discovery struct {
	...
	// relay (discovery:nodes snapshots for the om service), keyed by node ID (the
