...
func TestDefaultProxyPort(t *testing.T) {
	if defaultProxyPort != 1234 {
		t.Fatalf("default proxy port = %d, want 1234", defaultProxyPort)
	}
}
...
func TestChooseStartupPort(t *testing.T) {
	for _, tc := range []struct {
		...
		{"default", 1234, 0, false, false, 1234},
		{"custom survives", 1234, 12400, false, true, 12400},
